...
| IFCBINARY | ❌ | ✔️ | ✔️ |  |
| ifcboiler typeenum | ✔️ | ✔️ | ✔️ | xs:string |
...
| ifchumidertertypeenum（イフチュミディエーター・タイプ） | ✔️ | ✔️ | ✔️ | xs:string |
...
| イフクリニアルモーメント測定 | ✔️ | ✔️ | ✔️ | xs:double |
...
## XMLの基本型
`xs:restriction`、`base`属性に有効なXML base型のリストと、文字列表現の妥当性をチェックする関連正規表現は以下の通りです：
