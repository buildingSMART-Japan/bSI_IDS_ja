...
誰でもIDSリポジトリに貢献することができます。 アイデアや問題があるけれども、それを解決する方法がわからないという場合は、IDSリポジトリの[発行ボード](https://github.com/buildingSMART/IDS/issues)もし変更を加えて貢献したいのであれば、最も関連性の高いブランチ（おそらく'development'だが、バグ修正のためのバージョンブランチもありうる）をベースにした専用ブランチを作成してほしい。
