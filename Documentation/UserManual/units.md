...
| Ifc定義型名 | 物理量の説明 | 単位 | 単位 記号 | デフォルト表示 | 次元指数 | 単位列挙 | IfcSIUnitName 列挙型 |
| --------------------------------------------- | --------------------------------------- | ------------ | ----------- | --------------- | ----------------------- | ---------------------------------------------------------- | -------------------------------------------------- |
...
| イフクリニアモメント測定 | 線形モーメント |  |  | N m / m | (1, 1, -2, 0, 0, 0, 0) | IfcDerivedUnitEnum.LINEARMOMENTUNIT。 |  |
...
| もし断面積が小さかったら | 区間積分 |  |  | m5 | (5, 0, 0, 0, 0, 0, 0) | ifcDerivedUnitEnum.SECTIONALAREAINTEGRALUNIT |  |
